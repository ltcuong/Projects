...
import entity.HDThue;

public class GetFormHopDongThue extends BaseAction {
	...
	private String ngayKetThucChoThue;
	private String choThueTuNgay;
	...
	public String executeCapNhatThongTinHopDongThue() {
		memberShip = super.getMemberShip();
		...
		if (hopDongTam != null) {
			...
			HDThue hopDongThue = hopDong.getHopDongThue();
			if (hopDongThue == null) {
				hopDongThue = new HDThue();
			}
			hopDongThue.setThoiHanThue(thoiHanThue);
			Date d1 = null, d2 = null, d3 = null, d4 = null;
			if (ngayKetThucChoThue != null && !ngayKetThucChoThue.isEmpty()) {
				try {
					d1 = df.parse(ngayKetThucChoThue);
				} catch (ParseException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
			}
			hopDongThue.setNgayKetThucChoThue(d1);
			if (choThueTuNgay != null && !choThueTuNgay.isEmpty()) {
				try {
					d2 = df.parse(choThueTuNgay);
				} catch (ParseException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
			}
			hopDongThue.setChoThueTuNgay(d2);
			hopDongThue.setMucDichThue(mucDichThue);
			hopDongThue.setGiaThue(giaThue);
			hopDongThue.setPhuongThucThanhToan(phuongThucThanhToan);
			if (ngayGiaoTaiSan != null && !ngayGiaoTaiSan.isEmpty()) {
				try {
					d3 = df.parse(ngayGiaoTaiSan);
				} catch (ParseException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
			}
			hopDongThue.setNgayGiaoTaiSan(d3);
			hopDongThue.setCacThoaThuanKhac(cacThoaThuanKhac);
			...
			hopDongThue.setNgayCoHieuLuc(d4);
			
			// End thong tin rieng
			hopDong.setHopDongThue(hopDongThue);
			hopDongThue.setHopDong(hopDong);
	...
	public String getNgayKetThucChoThue() {
		return ngayKetThucChoThue;
	}

	public void setNgayKetThucChoThue(String ngayKetThucChoThue) {
		this.ngayKetThucChoThue = ngayKetThucChoThue;
	}

	public String getChoThueTuNgay() {
		return choThueTuNgay;
	}

	public void setChoThueTuNgay(String choThueTuNgay) {
