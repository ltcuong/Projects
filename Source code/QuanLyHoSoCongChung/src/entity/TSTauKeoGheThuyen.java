...
public class TSTauKeoGheThuyen implements Serializable {
	/**
	 * 
	 */
	...
	public static final String TS_NOICAPGIAYCNDANGKYTAU = "#NOICAPGIAYCNDANGKYTAU";
	public static final String TS_NGAYCAPGIAYCNDANGKYTAU = "#NGAYCAPGIAYCNDANGKYTAU";
	...
	private Date ngayCapGiayCNDangKyTau;
	...
	public Date getNgayCapGiayCNDangKyTau() {
		return ngayCapGiayCNDangKyTau;
	}

	public void setNgayCapGiayCNDangKyTau(Date ngayCapGiayCNDangKyTau) {
