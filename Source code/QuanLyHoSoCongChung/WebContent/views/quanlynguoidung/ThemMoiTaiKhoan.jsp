...
<script type="text/javascript"
	src="../js/quanlynguoidung/themmoitaikhoan.js"></script>
<div class="col_right">
	<div class="achor_link">
		<img src="../images/Home.png" height="16px;" width="16px;" /> Quản lý
		người dùng <img src="../images/Next.png" /> Thêm mới tài khoản
	</div>
	<div class="box-content">

		<div>
			<div id="dvMain" style="width: 100%">
				<form id="thongTinHoSoForm" method="get" action=""
					autocomplete="off">
					<fieldset>
							...
							<tbody>
								...
								<tr>
									<td style="text-align: right; color: Blue">Lặp lại mật
										khẩu</td>
									<td><input id="MatKhauConfirmID" name="matKhauConfirm"
										class="w-200" type="password" maxlength="128" required /></td>
									<td style="text-align: right">Địa chỉ liên lạc</td>
									<td><input name="diaChi" id="DiaChiID" value=''
										class="w-200" type="text" maxlength="500" /></td>
								</tr>
								<tr>
									<td style="text-align: right; color: Blue">Họ tên</td>
									<td><input name="hoTen" id="HoTenID" value=''
				...
				<div align="center" style="margin-top: 20px;">
					<s:if test="isAdd == 1">
					<input name="" value="Cập nhật" id="BtnCapNhatTaiKhoanID" class="btn_over"
						type="button" /> <input name="" value="Nhập lại" onclick="nhapLaiThongTinTaiKhoan();" class="btn_over"
						type="button">
						</s:if>
				</div>
			</div>
	...
	<div id="DanhSachTaiKhoanID"></div>
	<div class="Hidden">
		<div id="PopupThongTinTaiKhoanID" class="StatusPopup01">
			<div class="col_right"
				style="border-style: none; width: 100%; border-color: white;">
				<h4 style="margin-bottom: 0px;">Thông tin tài khoản</h4>
				<div id="FormTaiKhoanID"></div>
			</div>
		</div>
	</div>
</div>
...
<input type="hidden" id="ListHuyenChooseID" value="<s:property value='list_huyen'/>"/>
<input type="hidden" id="ListXaChooseID" value="<s:property value='list_xa'/>"/>
