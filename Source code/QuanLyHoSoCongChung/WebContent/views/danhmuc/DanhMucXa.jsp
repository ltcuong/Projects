...
<script type="text/javascript" src="../js/danhmuc/danhmucxa.js"></script>
<!--right !-->
<div class="col_right">
	<div class="box-content">
		<div class="col_right">
			<div class="achor_link"><img src="../images/themedefault/Home.png" height="16px;" width="16px;"/> Quản lý danh mục <img src="../images/themedefault/Next.png"/> Danh mục xã</div>
			<div class="box-content">
				<div id="dvMain">
					<div id="form">
