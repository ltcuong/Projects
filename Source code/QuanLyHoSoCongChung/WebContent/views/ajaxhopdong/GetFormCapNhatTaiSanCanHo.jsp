...
<form id="FormTaiSanCanHoID" method="get" action="" autocomplete="off">
<fieldset>
<table width="100%" cellspacing="5" cellpadding="5" border="0"
	...
	<tbody>
		...
		<tr>
			...
			<td colspan="2"><input type="text" name="moTa" value=""
				id="MoTaID" class="w-200" maxlength="200"></td>
		...
		<tr>
			...
			<td colspan="2"><input type="text" name="canHoSo" value=""
				id="CanHoSoID" class="w-200" maxlength="5"></td>
			<td style="text-align: right;">Căn hộ thuộc tầng</td>
			<td colspan="2"><input type="text" name="canHoThuocTang"
				value="" id="CanHoThuocTangID" class="w-200" maxlength="5"></td>
		</tr>
		<tr>
			<td style="text-align: right;">Số tầng nhà chung cư</td>
			<td colspan="2"><input type="text" name="soTangNhaChungCu"
				value="" id="SoTangNhaChungCuID" class="w-200" maxlength="5"></td>
		</tr>
		<tr>
