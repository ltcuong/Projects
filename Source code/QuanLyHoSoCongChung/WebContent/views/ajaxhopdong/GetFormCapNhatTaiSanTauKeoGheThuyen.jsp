...
<form id="FormTaiSanTauKeoGheThuyenID" method="get" action="" autocomplete="off">
<fieldset>
<table width="100%" cellspacing="5" cellpadding="5" border="0"
	...
	<tbody>
		<tr>
			...
			<td style="width: 30%" colspan="2"><input type="text"
				name="tenTau" value="" id="TenTauID" class="w-200" maxlength="100"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2"><input type="text" name="noiCapGCNDKTau"
				value="" id="NoiCapGCNDKTauID" class="w-200" maxlength="200"></td>
