...
<form id="FormHopDongMuaBanID" method="get" action="" autocomplete="off">
<fieldset>
		...
		<tr>
			<td colspan="6">
				<p style="color: #e60200;">
					<strong>Thông tin hợp đồng mua bán</strong>
				</p>
			</td>
		</tr>
		<tr>
			<td style="text-align: right; width: 15%; color: blue;">Giá mua bán</td>
			<td style="width: 30%" colspan="2"><input type="text" name="giaMuaBan" value="" id="GiaMuaBanID" class="w-200" maxlength="15" required /></td>
			<td style="text-align: right; width: 15%; color: blue;">Phương thức thanh toán</td>
			<td style="width: 30%"  colspan="2"><input type="text" name="phuongThucThanhToan" value="" id="PhuongThucThanhToanID" class="w-200" maxlength="200" required></td>
		</tr>
		<tr>
			...
			<td colspan="2"><input type="text" name="ngayGiaoTaiSan"
				value="" id="NgayGiaoTaiSanID" class="w-200" maxlength="10"></td>
		</tr>
		<tr>
