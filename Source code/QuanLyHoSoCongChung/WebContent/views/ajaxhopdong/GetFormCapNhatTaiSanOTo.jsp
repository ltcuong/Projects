...
<form id="FormTaiSanOToID" method="get" action="" autocomplete="off">
<fieldset>
<table width="100%" cellspacing="5" cellpadding="5" border="0"
	...
	<tbody>
		...
		<tr>
			...
			<td colspan="2"><input type="text" name="soChoNgoi" value=""
				id="SoChoNgoiID" class="w-200" maxlength="5"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2"><input type="text" name="taiTrong" value=""
				id="TaiTrongID" class="w-200" maxlength="50"></td>
		</tr>
		<tr>
			<td style="text-align: right;">Tự trọng</td>
			<td colspan="2"><input type="text" name="tuTrong" value=""
				id="TuTrongID" class="w-200" maxlength="50"></td>
			<td style="text-align: right;">Giấy đăng ký số</td>
			<td colspan="2"><input type="text" name="giayDangKySo" value=""
				id="GiayDangKySoID" class="w-200" maxlength="50"></td>
		</tr>
		<tr>
