...
<form id="FormTaiSanNhaID" method="get" action="" autocomplete="off">
<fieldset>
	...
	<tbody>
		...
		<tr>
			...
			<td colspan="2"><input type="text" name="dienTichDatXayDung"
				value="" id="DienTichDatXayDungID" class="w-200" maxlength="15"></td>
		...
		<tr>
			...
			<td colspan="2"><input type="text" name="ketCau" value=""
				id="KetCauID" class="w-200" maxlength="100"></td>
		</tr>
		<tr>
			...
			<td colspan="2"><input type="text" name="loaiCongTrinh" value=""
				id="LoaiCongTrinhID" class="w-200" maxlength="100"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2"><input type="text"
				name="vaoSoGiayCNQSDDSo" value=""
				id="VaoSoGiayCNQSDDSoID" class="w-200" maxlength="50"></td>
		</tr>
		<tr>
			<td style="text-align: right;">Giấy chứng nhận QSHTS số</td>
			<td colspan="2"><input type="text"
				name="giayChungNhanQSHTaiSanSo" value=""
				id="GiayChungNhanQSHTaiSanSoID" class="w-200"></td>
			<td style="text-align: right;">Ngày cấp GCNQSHTS</td>
			<td colspan="2"><input type="text"
				name="ngayCapGiayChungNhanQSHTS" value=""
				id="NgayCapGiayChungNhanQSHTSID" class="w-200" maxlength="50"></td>
		</tr>
		<tr>
